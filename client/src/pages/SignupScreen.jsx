        ...
        >
          ...
          <div className="hidden md:flex items-center justify-center bg-gradient-to-br from-[#071A2E] to-[#061827] p-12 h-full">
            <div className="w-full h-full flex flex-col items-center justify-center gap-6">
              ...
              <div className="text-center px-6">
                <h2 className="text-3xl md:text-4xl font-semibold text-white">Welcome to InterXview</h2>
                <p className="text-[#94a3b8] mt-3 max-w-xs md:max-w-sm">AI powered interview prep & CV optimization — get interview-ready faster.</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-12 bg-[#071A2E] flex items-center">
            <div className="max-w-lg w-full mx-auto">
              <h1 className="text-white text-3xl md:text-4xl font-semibold mb-2">Create Account</h1>
              <p className="text-[#94a3b8] mb-6 text-sm md:text-base">Join InterXview and unlock personalized interview practice.</p>
