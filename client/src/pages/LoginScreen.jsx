    ...
    <div className="min-h-screen flex flex-col bg-[#071A2E]">
      <div className="flex-1 flex items-center justify-center p-6">
        <motion.div
          ...
          style={{ background: 'linear-gradient(135deg, rgba(7,26,46,0.95) 0%, rgba(6,24,39,0.95) 100%)' }}
        >

          <div className="p-12 bg-[#071A2E] flex items-center">
            <div className="max-w-lg w-full mx-auto">
              <h1 className="text-white text-3xl md:text-4xl font-semibold mb-1">Welcome Back</h1>
              <p className="text-[#94a3b8] mb-6 text-sm md:text-base">Sign in to continue to InterXview.</p>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    >
                      {showPassword ? (
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10a9.964 9.964 0 012.058-5.637m4.5.658A3 3 0 0115 12a3 3 0 11-6 0c0-.314.051-.617.146-.896M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <Link to="/forgot" className="text-sm text-sky-400 hover:underline">Forgot password?</Link>
                </div>
          ...
          <div className="hidden md:flex items-center justify-center bg-gradient-to-br from-[#071A2E] to-[#061827] p-8">
            <div className="w-full h-full flex flex-col items-center justify-center gap-4">
              ...
              <div className="text-center px-6">
                <h2 className="text-2xl font-semibold text-white">Interview practice with AI</h2>
                <p className="text-[#94a3b8] mt-2">Practice real interview questions, get instant feedback, and improve faster.</p>
              </div>
            </div>
          </div>
